...
import './StudyText.scss';

import Popup from './components/Popup.jsx';
import Word  from './components/Word.jsx';

import * as demoAPI  from '../../../utilities/demo-api.js';
import * as wordsAPI from '../../../utilities/words-service.js';
  ...
  useEffect(
    function () {
      async function getTokenizedText() {
        if (text) {
          const thisTokenizedText = await demoAPI.tokenizeText(text.content);// change to productAPI
